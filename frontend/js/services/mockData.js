...
function initMockData() {
  ...
  // === MATERIALES ===
  store.materiales = [
    { id: 'mat-001', nombre: 'Granito Negro Absoluto', categoria: 'granito', tipo: 'Importado', espesor: '2cm', unidad: 'placas', costo: 185000, precioVenta: 280000, stockMinimo: 3, proveedor: 'prov-001', observaciones: 'Origen: India. Pulido espejo.' },
    { id: 'mat-002', nombre: 'Granito Gris Mara', categoria: 'granito', tipo: 'Nacional', espesor: '2cm', unidad: 'placas', costo: 120000, precioVenta: 195000, stockMinimo: 5, proveedor: 'prov-001', observaciones: 'Nacional, buen stock' },
    { id: 'mat-003', nombre: 'Mármol Carrara', categoria: 'marmol', tipo: 'Importado', espesor: '2cm', unidad: 'placas', costo: 250000, precioVenta: 380000, stockMinimo: 2, proveedor: 'prov-002', observaciones: 'Origen: Italia. Veteado clásico.' },
    { id: 'mat-004', nombre: 'Mármol Travertino Romano', categoria: 'travertino', tipo: 'Importado', espesor: '2cm', unidad: 'placas', costo: 145000, precioVenta: 225000, stockMinimo: 3, proveedor: 'prov-002', observaciones: '' },
    { id: 'mat-005', nombre: 'Silestone Blanco Zeus', categoria: 'silestone', tipo: 'Importado', espesor: '2cm', unidad: 'placas', costo: 320000, precioVenta: 480000, stockMinimo: 2, proveedor: 'prov-003', observaciones: 'Premium, muy demandado' },
    { id: 'mat-006', nombre: 'Silestone Gris Expo', categoria: 'silestone', tipo: 'Importado', espesor: '2cm', unidad: 'placas', costo: 290000, precioVenta: 440000, stockMinimo: 2, proveedor: 'prov-003', observaciones: '' },
    { id: 'mat-007', nombre: 'Cuarzo Blanco Stellar', categoria: 'cuarzo', tipo: 'Importado', espesor: '2cm', unidad: 'placas', costo: 210000, precioVenta: 320000, stockMinimo: 3, proveedor: 'prov-003', observaciones: '' },
    { id: 'mat-008', nombre: 'Granito Marrón Báltico', categoria: 'granito', tipo: 'Importado', espesor: '3cm', unidad: 'placas', costo: 175000, precioVenta: 265000, stockMinimo: 3, proveedor: 'prov-001', observaciones: '' },
    { id: 'mat-009', nombre: 'Mármol Botticino', categoria: 'marmol', tipo: 'Importado', espesor: '2cm', unidad: 'placas', costo: 200000, precioVenta: 310000, stockMinimo: 2, proveedor: 'prov-002', observaciones: '' },
    { id: 'mat-010', nombre: 'Porcelanato Gran Formato', categoria: 'porcelanato', tipo: 'Nacional', espesor: '1cm', unidad: 'm2', costo: 35000, precioVenta: 55000, stockMinimo: 20, proveedor: 'prov-004', observaciones: '120x60cm' },
    { id: 'mat-011', nombre: 'Bacha Simple Acero', categoria: 'otro', tipo: 'Nacional', espesor: '-', unidad: 'unidades', costo: 45000, precioVenta: 72000, stockMinimo: 5, proveedor: 'prov-004', observaciones: 'Para mesadas de cocina' },
    { id: 'mat-012', nombre: 'Bacha Doble Acero', categoria: 'otro', tipo: 'Nacional', espesor: '-', unidad: 'unidades', costo: 68000, precioVenta: 105000, stockMinimo: 3, proveedor: 'prov-004', observaciones: '' },
    { id: 'mat-013', nombre: 'Zócalo Granito Negro', categoria: 'granito', tipo: 'Nacional', espesor: '1cm', unidad: 'metros', costo: 15000, precioVenta: 25000, stockMinimo: 15, proveedor: 'prov-001', observaciones: 'h=10cm' },
    { id: 'mat-014', nombre: 'Pegamento Especial Mármol', categoria: 'otro', tipo: 'Nacional', espesor: '-', unidad: 'unidades', costo: 12000, precioVenta: 18000, stockMinimo: 10, proveedor: 'prov-005', observaciones: 'Balde 25kg' },
    { id: 'mat-015', nombre: 'Ónix Miel', categoria: 'onix', tipo: 'Importado', espesor: '2cm', unidad: 'placas', costo: 450000, precioVenta: 680000, stockMinimo: 1, proveedor: 'prov-002', observaciones: 'Material premium, retroiluminable' }
  ];
