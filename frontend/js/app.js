...
import { renderProveedores } from './pages/proveedores.js?v=10';
import { renderFacturas } from './pages/facturas.js?v=10';
import { renderPagos } from './pages/pagos.js?v=10';
import { renderCobros } from './pages/cobros.js';
import { renderConfiguracion } from './pages/configuracion.js';
import { DataService } from './services/mockData.js?v=10';
